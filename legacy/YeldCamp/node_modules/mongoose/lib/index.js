...
var VirtualType = require('mongoose/lib/virtualtype');
var STATES = require('mongoose/lib/connectionstate');
var Types = require('mongoose/lib/types');
var Query = require('mongoose/lib/query');
...
var pkg = require('mongoose/package.json');

var querystring = require('mongoose/lib/node_modules/querystring');
var saveSubdocs = require('mongoose/lib/plugins/saveSubdocs');
var validateBeforeSave = require('mongoose/lib/plugins/validateBeforeSave');

var Aggregate = require('mongoose/lib/aggregate');
var PromiseProvider = require('mongoose/lib/promise_provider');
var shardingPlugin = require('mongoose/lib/plugins/sharding');
